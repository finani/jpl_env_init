...
Config.instname = "Jet Propulsion Laboratory"
Config.profilename = "JPL eduroam"
Config.url = "your local eduroam® support page"
Config.email = "your local eduroam® support"
Config.title = "eduroam CAT"
Config.servers = ['DNS:net-acs-011.jpl.nasa.gov','DNS:net-acs-012.jpl.nasa.gov']
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.server_match = 'jpl.nasa.gov'
Config.eap_outer = 'PEAP'
Config.eap_inner = 'MSCHAPV2'
Config.use_other_tls_id = False
Config.tou = """Eduroam will grant you access to WiFi networks at participating institutions. Use of eduroam is a privilege and abuse of the Terms of Use at JPL or at other institutions may result in revoking of the right to use eduroam. 

Use of eduroam is only permitted by use of the packaged installers. Manual configuration for eduroam is in violation of these Terms of Use.

Currently, Android is not supported for eduroam due to some insecurities in its handling of WiFi authentication. Manual configuration of Android to connect to eduroam is in violation of these Terms of Use."""
...
"""
Config.anonymous_identity = 'anonymous@jpl.nasa.gov'
...
Config.sb_user_file = """"""
Config.user_realm = "jpl.nasa.gov"
run_installer()
