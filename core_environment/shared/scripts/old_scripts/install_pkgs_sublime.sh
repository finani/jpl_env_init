...
if [[ ! -e /etc/apt/sources.list.d/sublime-latest.list ]]; then
  echo "deb https://download.sublimetext.com/ apt/stable/" \
      > /etc/apt/sources.list.d/sublime-latest.list
  #wget -qO - https://download.sublimetext.com/sublimehq-pub.gpg > ./shared/keys/sublimehq-pub.gpg
  sudo apt-key add ./shared/keys/sublimehq-pub.gpg
fi
